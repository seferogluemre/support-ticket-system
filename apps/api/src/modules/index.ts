...
export const swaggerTags: { name: string; description: string }[] = [
  ...
  { name: "Post", description: "Post endpoints" },
  {
    name: "Projects",
    description:
      "Project management endpoints - demonstrates different permission levels (System Admin, Company Admin, Company Member)",
  },
  {
    name: "Ticket",
    description:
      "Support ticket management endpoints - Zendesk-like ticket system with company-scoped permissions",
  },
  {
    name: "Tag",
    description: "Etiket yönetimi endpoints - Ticket etiketleme sistemi",
  },
